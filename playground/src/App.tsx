    ...
    return (
        <main className="playground">
            <header>
                ...
                <p>
                    <code>react-canvas-masker</code> handles freehand mask painting. This plugin
                    adds a second mode where clicks on the image are sent to SlimSAM-77 running
                    locally in the browser via <code>onnxruntime-web</code>. First load downloads
                    ~14 MB of quantized ONNX weights and caches them; subsequent loads are instant.
                </p>
            </header>
